...
<div class="bg-light" id="redondo">
    <p class="text-center text-dark p-3">Una barbería con más de 10 años en el sector y dando cada año lo mejor. Contamos con un profesional especializado para ofrecerle al cliente el mejor resultado.
...
<div id="reseñas">
    ...
    @foreach($facturas as $factura)
        <div class="card" style="width: 18rem;" id="cartaReseña">
            <div class="card-body" >
